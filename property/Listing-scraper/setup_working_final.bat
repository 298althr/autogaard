@echo off
echo ========================================
echo Universal Scraper Windows Setup - WORKING VERSION
echo ========================================
echo.
...
REM Run working scraper
echo ========================================
echo Running Universal Scraper (WORKING MODE)
echo ========================================
echo.

%PYTHON_CMD% universal_scraper_working.py --batch links.txt --output scraped_data
