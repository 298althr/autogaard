@echo off
REM Robust Setup Script - Better error handling and debugging
...
echo ========================================
echo Universal Scraper Windows Setup - ROBUST VERSION
echo ========================================
echo.
...
echo ========================================
echo Running Universal Scraper (Robust Mode)
echo ========================================
echo.
