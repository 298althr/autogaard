@echo off
REM Robust Setup Script - Fixed batch label issue and Firefox support
...
echo ========================================
echo Universal Scraper Windows Setup - FIXED VERSION
echo ========================================
echo.
...
echo ========================================
echo Running Universal Scraper (Fixed Mode)
echo ========================================
echo.

%PYTHON_CMD% universal_scraper_robust.py --batch links.txt --output scraped_data
