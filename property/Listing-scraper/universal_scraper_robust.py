"""
Universal Scraper Windows - Robust Version
Fixed timeout issues and better error handling
"""
...
class RobustUniversalScraper:
    ...
    def extract_with_playwright(self, url: str, platform: str) -> dict:
        """Extract data using Playwright with robust error handling"""
        ...
        try:
            with sync_playwright() as p:
                ...
                while not navigation_success and navigation_attempts < max_attempts:
                    ...
                    try:
                        print(f"🔄 Navigation attempt {navigation_attempts}/{max_attempts}")
                        ...
                        print(f"⚠️ Navigation attempt {navigation_attempts} failed: {nav_error}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Universal Multi-Platform Scraper - Robust Version')
    ...
    # Initialize scraper
    scraper = RobustUniversalScraper()
    ...
    if args.batch:
        ...
        print("Example: python universal_scraper_robust.py --batch links.txt")
        print("Example: python universal_scraper_robust.py --url 'https://example.com'")
